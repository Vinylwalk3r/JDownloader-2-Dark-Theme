...
7. Copy the content of the [config](config/) folder into the opened backup. If asked, confirm overwriting exisiting files. ([laf](laf/) is the dark theme, [menus_v2](menus_v2/) is the toolbars) 
